  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'unternehmensname': (
      <div key="unternehmensname" className="space-y-1.5">
        ...
        <Input
          id="unternehmensname"
          placeholder="z. B. Tante Tinas Hundepension"
    ...
    'slogan': (
      <div key="slogan" className="space-y-1.5">
        ...
        <Input
          id="slogan"
          placeholder="z. B. Zuhause für dein liebes Tier"
          value={fields.slogan ?? ''}
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Dein Angebot in wenigen Sätzen..."
    ...
    'leistungen': (
      <div key="leistungen" className="space-y-1.5">
        ...
        <Textarea
          id="leistungen"
          placeholder="Eine Leistung pro Zeile – z. B. Tagesausflüge, Einzelfütterung, Medikamentengabe"
    ...
    'oeffnungszeiten': (
      <div key="oeffnungszeiten" className="space-y-1.5">
        ...
        <Textarea
          id="oeffnungszeiten"
          placeholder="Pro Tag eine Zeile – z. B. Mo–Fr 09:00–18:00, Sa 09:00–14:00"
    ...
    'email': (
      <div key="email" className="space-y-1.5">
        ...
        <Input
          id="email"
          type="email"
          placeholder="z. B. info@hundepension.de"
          value={fields.email ?? ''}
