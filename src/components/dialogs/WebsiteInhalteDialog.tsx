  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'unternehmensname': (
      <div key="unternehmensname" className="space-y-1.5">
        ...
        <Input
          id="unternehmensname"
          placeholder="z. B. PfotenPension Sonnenschein"
    ...
    'slogan': (
      <div key="slogan" className="space-y-1.5">
        ...
        <Input
          id="slogan"
          placeholder="z. B. Dein Hund ist bei uns in guten Händen"
          value={fields.slogan ?? ''}
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Kurze Beschreibung der Pension, Philosophie..."
    ...
    'leistungen': (
      <div key="leistungen" className="space-y-1.5">
        ...
        <Textarea
          id="leistungen"
          placeholder="Eine Leistung pro Zeile (z. B. Betreuung, Freilaufflächen, spezielle Diäten)"
    ...
    'oeffnungszeiten': (
      <div key="oeffnungszeiten" className="space-y-1.5">
        ...
        <Textarea
          id="oeffnungszeiten"
          placeholder="Eine Öffnungszeit pro Zeile (z. B. Mo–Fr 8–18 Uhr, Sa nach Vereinbarung)"
