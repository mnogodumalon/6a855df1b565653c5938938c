  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'unternehmensname': (
      <div key="unternehmensname" className="space-y-1.5">
        ...
        <Input
          id="unternehmensname"
          placeholder="z. B. PfotenPension München"
    ...
    'slogan': (
      <div key="slogan" className="space-y-1.5">
        ...
        <Input
          id="slogan"
          placeholder="z. B. Hundepension mit Liebe"
          value={fields.slogan ?? ''}
    ...
    'beschreibung': (
      <div key="beschreibung" className="space-y-1.5">
        ...
        <Textarea
          id="beschreibung"
          placeholder="Kurzbeschreibung des Angebots für Besucher..."
    ...
    'leistungen': (
      <div key="leistungen" className="space-y-1.5">
        ...
        <Textarea
          id="leistungen"
          placeholder="Eine Leistung pro Zeile (z. B. Tagesbetreuung, Spaziergang, Spiel)"
    ...
    'oeffnungszeiten': (
      <div key="oeffnungszeiten" className="space-y-1.5">
        ...
        <Textarea
          id="oeffnungszeiten"
          placeholder="Eine Zeitangabe pro Zeile (z. B. Mo–Fr 8–19 Uhr)"
