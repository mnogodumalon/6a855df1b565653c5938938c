...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neue-buchung', label: { de: 'Neue Buchung', en: 'New booking' }, icon: IconCalendarPlus, description: 'Buchung in wenigen Schritten anlegen — Besitzer, Hund, Zeitraum und Platz' },
  { path: '/intents/anfrage-bearbeiten', label: { de: 'Anfrage bearbeiten', en: 'Handle request' }, icon: IconClipboardCheck, description: 'Buchungsanfrage bestaetigen oder ablehnen und direkt in einen Aufenthalt umwandeln' },
  { path: '/intents/pfoten-portraet', label: { de: 'Pfoten-Porträt', en: 'Paw portrait' }, icon: IconPaw, description: 'Individuelles Pfoten-Porträt fuer einen Hund erstellen' },
  // </custom:intents>
];
