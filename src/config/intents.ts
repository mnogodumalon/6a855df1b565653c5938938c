...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neue-buchung', label: { de: 'Neue Buchung', en: 'New booking' }, icon: IconCalendarPlus, description: 'Neue Belegung in 3 Schritten anlegen — Besitzer, Hund, Zeitraum & Platz' },
  { path: '/intents/anfrage-bestaetigen', label: { de: 'Anfrage bestätigen', en: 'Confirm request' }, icon: IconCheckbox, description: 'Buchungsanfrage pruefen und direkt als Aufenthalt bestaetigen oder ablehnen' },
  { path: '/intents/pfoten-portraet', label: { de: 'Pfoten-Porträt', en: 'Paw portrait' }, icon: IconHeart, description: 'Individuelles Pfoten-Portraet fuer einen Hund erstellen' },
  // </custom:intents>
];
