// Auto-generated. Per-entity form-enhancements config for "Belegung & Buchungen".
...
export const formEnhancements: FormEnhancements = {
  ...
  computed: {
    '_buchung_dauer_nächte': { kind: 'dateDiff', from: 'anreisedatum', to: 'abreisedatum', unit: 'days' },
  },
};
